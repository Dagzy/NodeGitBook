...
* [js_library]()
    * [05 - Express Server]()
        ...
        * [13 - More Sequelize Functions]()
            * [Migrations]()
                * [00 - Intro](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/00-migrations-intro.md)
                * [01 - init and config](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/01-init-config.md)
                * [02 - Creating the First Migration](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/02-first-migration.md)
                * [03 - Running Migrations](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/03-running-migrations.md)
                * [04 - Reverting Migrations](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/04-reverting.md)
                * [05 - Seeds](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/05-seeds.md)
                * [06 - Reverting Seeds](javascript_library/06-Express-Server/13-advanced-sequelize/migrations/06-reverting-seeds.md)
            * [Queries]()
                * [00 - Intro](javascript_library/06-Express-Server/13-advanced-sequelize/queries/00-queries-intro.md)
                * [01 - Queries](javascript_library\06-Express-Server\13-advanced-sequelize\queries\01-queries.md)
